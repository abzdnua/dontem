...
/**
 * This is the model class for table "delivery_msg".
 *
 * The followings are the available columns in table 'delivery_msg':
 * @property integer $id
 ...
 */
class BaseDeliveryMsg extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, create_user_id, create_date, change_user_id, change_date, delete_denied, deleted', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BaseDeliveryMsg the static model class
	 */
