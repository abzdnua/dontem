 ...
 */
class BaseClients extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, phone, email, address, create_user_id, create_date, change_user_id, change_date, delete_denied, deleted', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BaseClients the static model class
	 */
