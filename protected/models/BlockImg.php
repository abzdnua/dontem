 ...
 *
 * The followings are the available columns in table 'block_img':
 * @property integer $id
 ...
 */
class BlockImg extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('block_id, file_id, create_user_id, change_user_id, delete_denied, deleted', 'numerical', 'integerOnly'=>true),
			array('img_type', 'length', 'max'=>20),
			array('create_time, change_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, block_id, img_type, file_id, create_user_id, create_time, change_user_id, change_time, delete_denied, deleted', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BlockImg the static model class
	 */
