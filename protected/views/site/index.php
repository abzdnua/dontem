...
<h2>ООО «ДОНТЭМ» – энергомонтажная компания, обладающая всеми необходимыми лицензиями и разрешениями на производство работ повышенной опасности.</h2>
    <div class="blue_block" style="margin-bottom: 20px;">
        Мы – энергоремонтная компания, обладающая при этом еще и лицензией<br/>
        на строительные работы
    </div>
    <h2 style="margin-bottom: 20px;margin-top: 30px">Основная сфера деятельности ООО «ДОНТЭМ»</h2>
    <div class="text" style="margin-bottom: 32px;" >Монтаж тепломеханического оборудования электростанций, реконструкция и ремонт любой категории сложности основного и вспомогательного оборудования. Наши ведущие технические специалисты работают в энергетике уже не&nbsp;один десяток лет.</div>
...
<!--a href="<?=Yii::app()->urlManager->createUrl('site/baraban')?>" class="baraban_block"-->
    <a class="baraban_block main">
        В ООО «ДОНТЭМ» работает более 1000 высококвалифицированных специалистов, основной персонал – сварщики, монтажники, слесари, изолировщики и огнеупорщики – аттестованные специалисты, прошедшие специальное обучение.
    </a>
</div>
