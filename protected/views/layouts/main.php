...
// $this->redirect('http://dontem.com.ua')?>
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter23432743 = new Ya.Metrika({id:23432743,
                    webvisor:true,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/23432743" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<script>
  ...
  ga('create', 'UA-32413438-18', 'dontem.com.ua');
  ga('send', 'pageview');
...
}).on('mouseleave ','.block_news ul li',function(){
...
<div class="ph f_r">(062) 381-31-87</div>
        <div class="menu f_l">
            <ul>
                ...
                <li><a class= "<? if(strpos(Yii::app()->controller->action->id,'principles')!==false){echo 'color_menu';} ?>" href="<?=Yii::app()->urlManager->createUrl('site/principles')?>">Принципы компании </a> </li>
