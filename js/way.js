var Map2 = function(){
    ...
    (function
        ...
        eqLocation = new google.maps.LatLng(48.02187,37.801498);
        var mapOptions = {
            zoom: 14,
            center:  new google.maps.LatLng(48.02187,37.801498),
        ...
        eqMarker = new google.maps.Marker({
            position: eqLocation,
            map: map,
            icon: 'images/img_place.png',
            title: 'dontem',

        });

        eqInfo = new google.maps.InfoWindow({
            content:'<div class="dfdf" style="width: 258px; text-align: center;">Донецк, пр. Титова 8-б</div> '
